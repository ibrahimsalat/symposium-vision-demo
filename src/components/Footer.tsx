        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Reimagining academia with community, collaboration, and fair recognition at its core.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/feed" className="text-gray-300 hover:text-teal">For You Feed</Link></li>
              <li><Link to="/papers" className="text-gray-300 hover:text-teal">Peer Checking</Link></li>
